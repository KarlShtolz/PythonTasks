...
"""
Нужно вывести в консоль представление календаря на месяц по входным данным в виде строки
содержащей через пробел количество дней в месяце и день недели на который выпадает первое число
